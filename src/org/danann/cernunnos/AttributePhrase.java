...
public final class AttributePhrase implements Phrase {
	...
	public AttributePhrase(Phrase name) {
		this.name = name;
		this.dflt = null;	// Signifies none was specified...
	}
	 ...
	 * @throws IllegalArgumentException If <code>dflt</code> is
	 * <code>null</code>
	 */
	...
	public AttributePhrase(Phrase name, Phrase dflt) {
		...
		// Assertions.
		if (dflt == null) {
			String msg = "Argument 'dflt' cannot be null.";
			throw new IllegalArgumentException(msg);
		}

		this.name = name;	// May be null... is this ok?
		this.dflt = dflt;
