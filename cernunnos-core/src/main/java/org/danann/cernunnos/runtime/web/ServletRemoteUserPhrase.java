...
/**
 * Implements a Phrase that returns a the REMOTE_USER from the {@link 
...
public class ServletRemoteUserPhrase implements Phrase {
	...
	public static final Reagent SOURCE = new SimpleReagent("SOURCE", "@source", ReagentType.PHRASE, HttpServletRequest.class,
					"Optional source request against which the REMOTE_USER will be returned from.  If not "
	...
	public Formula getFormula() {
		...
		return new SimpleFormula(ServletRemoteUserPhrase.class, reagents);
	}
