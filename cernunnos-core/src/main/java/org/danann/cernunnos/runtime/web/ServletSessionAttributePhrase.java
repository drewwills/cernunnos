 ...
 */
public class ServletSessionAttributePhrase implements Phrase {
	...
	public static final Reagent SOURCE = new SimpleReagent("SOURCE", "@source", ReagentType.PHRASE, HttpServletRequest.class,
					"Optional source request against which the session attribute will be returned from.  If not "
	...
	public Formula getFormula() {
		...
		return new SimpleFormula(ServletSessionAttributePhrase.class, reagents);
	}
	...
	public Object evaluate(TaskRequest req, TaskResponse res) {
		...
		return hreq.getSession().getAttribute(attributeName);
	}
