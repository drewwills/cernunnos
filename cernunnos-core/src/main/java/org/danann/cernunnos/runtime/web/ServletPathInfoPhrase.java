...
/**
 * Implements a Phrase that returns a the PATH_INFO from the {@link 
 * javax.servlet.http.HttpServletRequest HttpServletRequest}.  
 * 
 * @author <A href="mailto:argherna@gmail.com">Andy Gherna</A>
 */
public class ServletPathInfoPhrase implements Phrase {
	...
	public static final Reagent SOURCE = new SimpleReagent("SOURCE", "@source", ReagentType.PHRASE, HttpServletRequest.class,
					"Optional source request against which the PATH_INFO will be returned from.  If not "
	...
	public Formula getFormula() {
		...
		return new SimpleFormula(ServletPathInfoPhrase.class, reagents);
	}
