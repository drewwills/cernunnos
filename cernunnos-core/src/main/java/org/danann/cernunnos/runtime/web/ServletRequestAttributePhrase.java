 ...
 */
public class ServletRequestAttributePhrase implements Phrase {
	...
	public static final Reagent SOURCE = new SimpleReagent("SOURCE", "@source", ReagentType.PHRASE, HttpServletRequest.class,
					"Optional source request against which the attribute will be returned from.  If not "
	...
	public Formula getFormula() {
		...
		return new SimpleFormula(ServletRequestAttributePhrase.class, reagents);
	}
	...
	public Object evaluate(TaskRequest req, TaskResponse res) {
		...
		return hreq.getAttribute(attributeName);
	}
