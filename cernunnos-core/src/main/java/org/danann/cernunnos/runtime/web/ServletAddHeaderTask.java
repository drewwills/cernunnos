...
/**
 * Implements a Task that adds a header on an {@link javax.servlet.http.HttpServletResponse
 * HttpServletResponse} from Cernunnos XML.
 * 
 * @author <A href="mailto:argherna@gmail.com">Andy Gherna</A>
 */
public class ServletAddHeaderTask implements Task {
	...
	public static final Reagent SOURCE = new SimpleReagent("SOURCE", "@source", ReagentType.PHRASE, HttpServletResponse.class,
								"Optional source response to add the header to.  If not specified, the value of "
	...
	public Formula getFormula() {
		...
		final Formula rslt = new SimpleFormula(ServletAddHeaderTask.class, reagents);
		return rslt;
	}
