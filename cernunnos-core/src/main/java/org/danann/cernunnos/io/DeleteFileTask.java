...
public class DeleteFileTask implements Task {
	...
	private Phrase file;
	private final Log log = LogFactory.getLog(DeleteFileTask.class);	// Don't declare as static in general libraries
	...
	public void perform(TaskRequest req, TaskResponse res) {
		...
		try {
			...
			if (log.isTraceEnabled()) {
				log.trace("Deleting file '" + f.getAbsolutePath() + "' and all contents.");
			}
	...
	private void delete(File file) {
		...
		// Assertions.
		if (file == null) {
			String msg = "Argument 'file' cannot be null.";
